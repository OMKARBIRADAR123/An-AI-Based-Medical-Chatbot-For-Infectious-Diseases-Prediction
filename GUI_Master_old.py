...
root.title("Multi Cancer Detection and Medical_Chabot Using Machine Learning")
...
img2=ImageTk.PhotoImage(Image.open("l1.jpg"))

img3=ImageTk.PhotoImage(Image.open("l2.jpg"))
...
move()'''
#
lbl = tk.Label(root, text="Multi Cancer Detection and Medical_Chabot Using Machine Learning", font=('times', 25,' bold '), height=1, width=70,bg="maroon",fg="white")
lbl.place(x=0, y=10)
frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=220, height=400, bd=5, font=('times', 14, ' bold '),bg="violet")
frame_alpr.grid(row=0, column=0, sticky='nw')
frame_alpr.place(x=15, y=120)
...
#    global fn
    ...
    if fn!="":
        ...
        cancer=np.argmax(prediction)
        print(cancer)
        
        
        
        if cancer == 0:
            Cd="Benign Skin Cancer"
        elif cancer == 1:
            Cd="Malignant Skin Cancer"
        elif cancer == 2:
            Cd="Oral Cancer"
        elif cancer == 3:
            Cd="Oral Cancer Not"
        ...
        #      Cd="Normal Eyes" 
        # elif cancer == 7:
        #     Cd="Cataract Eye Disease" 
        # elif cancer == 8:
        #     Cd="Glaucoma Eye Disease"
...
#
#
button5 = tk.Button(frame_alpr,text="chatbot", command=chat,width=15, height=1, font=('times', 15, ' bold '),bg="yellow4",fg="white")
