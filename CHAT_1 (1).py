...
def chatbot_response(msg):
    ...
    if 'CHICKEN POX' in res:
        db = sqlite3.connect('F:/2023 Data/Softech mayuri code/Mayuri Groups/Mayuri Groups/23SS270-medicle chatbot and disease prediction/Multicancer & Medical chatbot/Doctors.db')
        c = db.cursor()
