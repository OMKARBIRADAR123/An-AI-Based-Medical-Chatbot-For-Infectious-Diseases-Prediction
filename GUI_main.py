...
#
label_l1 = tk.Label(root, text="Multi Cancer Detection and Medical_Chabot Using Machine Learning",font=("Times New Roman", 27, 'bold'),
                    background="brown", fg="white", width=80, height=1)
